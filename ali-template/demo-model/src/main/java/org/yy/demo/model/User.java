...
public class User implements Serializable {
    ...
    * 注释内容
    */
    private static final long serialVersionUID = 7706206104861736909L;
    ...
    @Field(cnname = "状态", desc = "状态, 1表示生效，0表示注销,  2表示禁用", type = TypeEnum.INTETER, nullable = false)
    @NotNull
    ...
    */
    ...
    //尽量简称，但必须保证不重复
    public static final transient String NAMESPACE = "demo:user:1";
    
    //默认缓存过期时间, 默认缓存10天
    public static final transient int EXPIRATION = 60 * 60 * 24 * 10;
    
  //默认缓存过期时间, 列表默认缓存5分钟
    public static final transient int LIST_EXPIRATION = 60 * 5;
