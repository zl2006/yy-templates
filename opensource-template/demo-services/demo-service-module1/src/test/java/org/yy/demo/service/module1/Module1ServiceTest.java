...
* @since  [APP-DEMO/0.1]
*/
public class Module1ServiceTest extends AbstractSpringTest {
    
    @Resource(name = "module1Service")
    private Module1Service module1Service;
    
    @Test
    public void testModule1Method() {
        Assert.assertEquals("module1", module1Service.module1Method());
    }
}
